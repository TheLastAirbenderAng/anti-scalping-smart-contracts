...
contract EventOrganizer {
    ...
    function listTicketForSale(uint256 _ticketIndex, uint256 _price) external onlyOrganizer {
    allTickets[_ticketIndex].listForSale(_price);
    }   
    
    function transferTicketTo(uint256 _ticketIndex, address _newOwner) external onlyOrganizer {
    allTickets[_ticketIndex].transferTicket(_newOwner);
    }

    function unlistTicketForSale(uint256 _ticketIndex) external onlyOrganizer {
    allTickets[_ticketIndex].unlistForSale();
    }
